                    ...
                    <div class="container">
                        <div class="row ">
                            <div class="form-group">
                                <br>Blogger ID<input type="text" class="form-control rounded-left" name="id"
                                    value="{{$data}}" placeholder="ID" readonly>
                            </div>
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control rounded-left" name="b_phone"
                                    value="{{old('b_phone')}}" placeholder="Phone" required>
                            </div>
                            @error('b_phone')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="form-group">
                                <input type="email" class="form-control rounded-left" name="b_email"
                                    value="{{old('b_email')}}" placeholder="Email">
                            </div>
                            @error('b_email')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="form-group d-flex">
                                <input type="password" class="form-control rounded-left" name="b_password"
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control rounded-left" name="b_address"
                                    value="{{old('b_address')}}" placeholder="Address" required>
                            </div>
                            @error('b_address')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary rounded submit p-3 px-5">Confirm
                                    Registration</button>
                            </div>
                            <div class="form-group">
                                <button type="submit" class="btn btn-light rounded submit p-3 px-5">
